...
- Сделал `User.registered` необновляемым
- В `RootController` добавил логирование
...
- Отключил `JdbcUserServiceTest`. Будем чинить в `7_06_HW6_jdbc_transaction_roles.patch`
...
### ![correction](https://cloud.githubusercontent.com/assets/13649199/13672935/ef09ec1e-e6e7-11e5-9f79-d1641c05cbe6.png)  Apply 7_17_fix.patch - fix css/readme
