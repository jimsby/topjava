...
- Поправил использование переменных в JSP. Сервлеты удалили, без `jsp:useBean` уже интеграция не работает.
- Фикс: [тесты JUnit 5 перестали запускаться из IDEA](https://youtrack.jetbrains.com/issue/IDEA-231927)
